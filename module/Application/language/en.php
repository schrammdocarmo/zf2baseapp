...
////////////// S I T E
	...
	//Greeting
	'Welcome' => 'Welcome to example.net!',

	//Foooter
	'All rights reserved' => 'All rights reserved',

	//User actions - page titles
	...
	'registration_mail_text' => "Welcome!\n\nPlease use the link below to login for the first time in order to activate your account:\n%s\n\n",
	'registration_mail_html' => "<html><body>Welcome!<br/><br/>Please use the link below to login for the first time in order to activate your account:<br/>%s<br/><br/></body></html>",
	'registration_mail_subject' => "Welcome!",

	//EMAIL Contact
	'contact_mail_text' => "Company: %s\nFirst name: %s\nLast name: %s\nE-mail: %s\n\nMessage:\n%s\n\n",
	'contact_mail_html' => "<html><body>Company: %s<br/>First name: %s<br/>Last name: %s<br/>E-mail: %s<br/><br/>Message:<br/>%s<br/><br/></body></html>",
	'contact_mail_subject' => "Contact request",

	//EMAIL User forgot password
	'forgotpwd_mail_text' => "Hi!\n\nWe are sorry to hear that you forgot your password. Please use the link below to reset your password:\n%s\n\n",
	'forgotpwd_mail_html' => "<html><body>Hi!<br/><br/>We are sorry to hear that you forgot your password. Please use the link below to reset your password:<br/>%s<br/><br/></body></html>",
	'forgotpwd_mail_subject' => "Welcome!",

	//Forgot + Reset password message
	'forgotpwd_mail_sent' => 'An email with a link to reset your password has been sent to %s',
	'resetpwd_confirmation' => 'The password for %s has been updated',
...
/////////////////// F O R M S
	...
	//Login + Registration + Forgot/Reset pwd
	'Password' => 'Password',
	...
	'Set my new password' => 'Set my new password and log me in!',

	//Phone Form Element
	'Please use digits only' => 'Please use digits only! You may use +, - and spaces.',



/////////////////// Z E N D  F R A M E W O R K  V A L I D A T O R S
